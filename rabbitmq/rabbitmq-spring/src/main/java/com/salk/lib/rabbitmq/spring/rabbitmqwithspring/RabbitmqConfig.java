package com.salk.lib.rabbitmq.spring.rabbitmqwithspring;

import com.salk.lib.rabbitmq.spring.conveter.SalkImageConverter;
import com.salk.lib.rabbitmq.spring.conveter.SalkWordConverter;
import com.salk.lib.rabbitmq.spring.messagedelegate.SalkMsgDelegate;
...
public class RabbitmqConfig {
    ...
    public ConnectionFactory connectionFactory () {
        ...
        cachingConnectionFactory.setAddresses("172.168.1.136:5670");
    ...
    public TopicExchange topicExchange() {
        TopicExchange topicExchange = new TopicExchange("salk.topic.exchange",true,false);
        return topicExchange;
    }

    @Bean
    public DirectExchange directExchange() {
        DirectExchange directExchange = new DirectExchange("salk.direct.exchange",true,false);
        return directExchange;
    }

    @Bean
    public FanoutExchange fanoutExchange() {
        FanoutExchange fanoutExchange = new FanoutExchange("salk.faout.exchange",true,false);
    ...
    public SimpleMessageListenerContainer simpleMessageListenerContainer() {
        ...
        //创建消息监听适配器对象
        //自己创建一个消息委托器对象
        MessageListenerAdapter messageListenerAdapter = new MessageListenerAdapter(new SalkMsgDelegate());
...
/*        Map<String,String> queueOrTagToMethodName = new HashMap<>();
        ...
        //版本问题 需要设置信任的包
        javaTypeMapper.setTrustedPackages("com.salk.lib.rabbitmq.spring.entity");
        //json转java得
        ...
        messageConverter.addDelegate("img/png", new SalkImageConverter());
        messageConverter.addDelegate("img/jpg",new SalkImageConverter());
        messageConverter.addDelegate("application/word",new SalkWordConverter());
        messageConverter.addDelegate("word",new SalkWordConverter());
