...
import com.salk.lib.rabbitmq.springboot.producer.entity.Order;
...
public class SalkMsgSender {
    ...
    public void sendMsg(Object msg,Map<String,Object> msgProp) {
        ...
        //开启确认模式
        rabbitTemplate.setConfirmCallback(new SalkConfirmCallBack());

        //开启消息可达监听
        rabbitTemplate.setReturnCallback(new SalkRetrunCallBack());
